      ...
      <header className={styles.header}>
        <div className={styles.text}>
          ...
          <ExpandBox>
            ...
            <ModuleContent>
              <p>
                ...
                management system, with particular reference to its application
                during complex public health emergencies such as the COVID-19
                pandemic. The goal of the module is to increase understanding of
                the utility and application of IMS for public health emergency
                management, covering both theoretical and practical aspects.{' '}
              </p>
              <h4>Learning objectives</h4>
              <ul>
                <li>
                  Summarize roles, responsibilities and minimum requirements of
                  key positions and personnel within IMS
                </li>
                <li>
                ...
                <li>
                  Apply knowledge to update current structures and protocols
                  (i.e. from COVID-19) to future all-hazard preparedness and
                  response{' '}
                </li>
              </ul>
              ...
              <ul>
                <li>
                  ...
                  opportunities and challenges, Global Health Journal,
                  4(4):112-120{' '}
          ...
          <ExpandBox>
            ...
            <ModuleContent>
              <p>
                This module will cover how to approach data and resource
                management within the context of preparedness, response, and
                recovery, with an emphasis on how these management functions
                relate to decision-making. The goal is to ensure that
                participants understand ways to obtain, utilize, and manage
                different types of critical resources in an operational
                environment.
              </p>
              <h4>Learning objectives</h4>
              <ul>
                <li>
                  Identify best practices for data management and
                  decision-making
                </li>
                <li>
                  Define resource requirements for different response
                  levels/phases
                </li>
                <li>
              ...
              <h5>
                2.3: Resource requirements and managing resources: Jim Banaski,
                USA
              </h5>
              <div className={styles.image}>
                <iframe
              ...
              <ul>
                <li>
                  ...
                  Management Tool for Public Health Continuity of Operations
                  During Disasters. Disaster Medicine and Public Health
                  Preparedness, 7(2), 146-152. doi:10.1017/dmp.2013.24
                </li>
              </ul>
            </ModuleContent>
          </ExpandBox>
          <ExpandBox>
            ...
            <ModuleContent>
              <p>
                ...
                multisectoral partners, including protocols for both internal
                and external (including public) communication, and testing
                coordination structures via exercises. The goal is to equip
                participants with the knowledge and skills to design and
                implement different strategies for coordination and
                communication, including in the context of large-scale and
                complex operations.
              </p>
              <h4>Learning objectives</h4>
              <ul>
                <li>
                  Develop approaches for engaging multisectoral partners in
          ...
          <ExpandBox>
            ...
            <ModuleContent>
              <p>
                ...
                management. The goal is to encourage participants to think
                beyond technical skills to the broader leadership, advocacy, and
                continuous education required to ensure long-term function of an
